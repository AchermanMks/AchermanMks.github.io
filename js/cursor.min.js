function _createForOfIteratorHelper(e, t) {
    ...
    if (Array.isArray(e) || (i = _unsupportedIterableToArray(e)) || t && e && "number" == typeof e.length) return i && (e = i),
    a = 0,
    {
        s: t = function() {},
        n: function() {
...
function() {
    ...
    function() {
        ...
        r.innerHTML = '* { cursor: url("data:image/svg+xml, <svg xmlns=\\"http://www.w3.org/2000/svg\\" viewBox=\\"0 0 8 8\\" width=\\"8px\\" height=\\"8px\\"><circle cx=\\"4\\" cy=\\"4\\" r=\\"4\\" opacity=\\".5\\"/></svg>") 4 4, auto !important; }',
    ...
    function(e) {
        r.now || (n.style.left = e.clientX - 8 + "px", n.style.top = e.clientY - 8 + "px"),
        r.now = {
            x: e.clientX - 8,
            y: e.clientY - 8
        },
    ...
    requestAnimationFrame(function e() {
        ...
        n.style.left = r.pre.x + "px", n.style.top = r.pre.y + "px") : r.pre = r.now,
